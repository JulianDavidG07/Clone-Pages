<template>
  ...
  <nav class="flex justify-between px-16 fixed w-full bottom-0 bg-orange-200">
      <div>
      ...
      <div >
        ...
        <div class="block">Iniciar Sesión</div>
      </div>
